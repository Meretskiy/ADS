package com.meretskiy.ads.hash.task08;

import com.meretskiy.ads.hash.lesson.DoubleHashTableImpl;
import com.meretskiy.ads.hash.lesson.HashTable;
import com.meretskiy.ads.hash.lesson.Product;

public class MainClass {
    public static void main(String[] args) {
        HashTable<Product, Integer> hashTable = new HashTableChainImpl<>();
